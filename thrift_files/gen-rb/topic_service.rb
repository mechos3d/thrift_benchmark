  ...
  module TopicService
    class Client
      ...
      def get_feature(size)
        send_get_feature(size)
        return recv_get_feature()
      end

      def send_get_feature(size)
        send_message('get_feature', Get_feature_args, :size => size)
      end
    ...
    class Processor
      ...
      def process_get_feature(seqid, iprot, oprot)
        ...
        result.success = @handler.get_feature(args.size)
    ...
    class Get_feature_result
      ...
      FIELDS = {
        SUCCESS => {:type => ::Thrift::Types::STRUCT, :name => 'success', :class => ::ThriftBenchmark::QueryResult}
      }
